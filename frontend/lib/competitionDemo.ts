...
export const COMPETITION_SCENES: Record<CompetitionSceneId, CompetitionScene> = {
  "elder-fall": {
    id: "elder-fall",
    query: "elder-fall",
    eyebrow: "SCENE A · ELDER CARE",
    title: "老人夜间疑似跌倒",
    subtitle: "具身机器人 + 家庭灯光 + Watch + Phone 闭环看护",
    targetName: "李爷爷",
    ...
    flow: ["感知跌倒", "开灯", "Robot 前往现场", "Watch / Phone 联动", "老人反馈", "风险重新评估"],
  },
  "child-door": {
    id: "child-door",
    query: "child-door",
    eyebrow: "SCENE B · CHILD CARE",
    title: "儿童独处陌生敲门",
    subtitle: "Robot + DoorLock + SmartScreen + Watch + Phone 安全协同",
    targetName: "小宇",
    ...
    flow: ["门口异常", "门锁保持", "Robot 主动保护", "智慧屏 / Watch / Phone 协同", "家长确认", "闭环结束"],
  },
};
